...
void main() {
  ...
  group('post', () {
    ...
    test('Should call post with correct values', () async {
      ...
      await sut.request(url: url, method: 'post', body: {'any_key': 'any_value'}, headers: {'any=header': 'any_value'});
  ...
  group('get', () {
    ...
    test('Should call post with correct values', () async {
      ...
      await sut
          .request(url: url, method: 'get', headers: {'any_header': 'any_value'});
