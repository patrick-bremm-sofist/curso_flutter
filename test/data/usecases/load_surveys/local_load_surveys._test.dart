...
void main() {
  ...
  group('load', () {
    ...
    test('Should call CacheStorage if correct key', () async {
      await sut.load();
  ...
  group('save', () {
    ...
    test('Should call CacheStorage if correct values', () async {
      final list = [{
        'id': surveys[0].id,
    ...
    test('Should throw CacheStorage if save throws', () async {
      mockSaveError();
