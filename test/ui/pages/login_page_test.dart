...
void main() {
  ...
  testWidgets('Should presenter error if email is empty',
      (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should presenter error if password is empty',
      (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should enabled form button if form is valid',
      (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should change page', (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle(); // pumpAndSettle wait animation
